...
namespace Capstone.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "User_ID,Nome,Cognome,Email,Indirizzo,Password,Ruolo")] Users users)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Nome,Cognome,Indirizzo,Email,Password,Ruolo")] Users users)
        {
